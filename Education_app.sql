...
INSERT INTO `memberinfo` VALUES (1,'ksi','1234','김성일',0,'4','학생'),(2,'kkt','1234','김기태',0,'4','학생');
...
INSERT INTO `test` VALUES (1,'꼬리는 연한 황갈색을 띠면서 여덟 줄의 검은 고리 모양의 가로무늬가 있는 우리나라에서 가장 큰 맹수인 이 동물은?','http://www.nature.go.kr/fileUpload/animals/basic/KNAM-MM-0000120_001.jpg','호랑이','동물'),(2,'천연기념물 제 218호인 이 곤충은 무엇인가요? ','http://www.nature.go.kr/fileUpload/photo/O1/ZOBL0003_1.jpg','장수하늘소','곤충'),(3,'남한에서 제주도에만 분포하고있는 이 나비의 이름은 무엇입니까?','http://www.nature.go.kr/fileUpload/photo/R1/ZREP0016_1.jpg','산굴뚝나비','곤충'),(4,'검정풍뎅이과 중 가장 대형이며 1950년대까지만 해도 서울에서 많이 볼 수 있었던 이 곤충은 무엇인가?','http://www.nature.go.kr/fileUpload/photo/O1/ZOEJ0031_1.jpg','수염풍뎅이','곤충'),(5,'우리나라에 살고 있는 잠자리중 가장 작은 잠자리인 이 곤충은 무엇인가?','http://www.nature.go.kr/fileUpload/photo/D1/ZDAP0008_1.jpg','꼬마잠자리','곤충'),(6,'유충일때 땅 속에 수직굴을 파고 속에 있다가 지나가는 곤충을 잡아먹는 이 곤충은 무엇인가?','http://www.nature.go.kr/fileUpload/photo/O1/ZOBU0004_1.jpg','닻무늬길앞잡이','곤충'),(7,'이 곤충은 무엇인가?','http://www.nature.go.kr/fileUpload/photo/D1/ZDAP0001_1.jpg','대모잠자리','곤충'),(8,'몸은 황갈색 또는 연한 갈색이며, 앞가슴등판 가운데의 가는 세로 줄과 양 옆의 뒤쪽에 있는 둥근 무늬, 딱지날개의 가운데와 가장자리의 가는 줄 등은 흑색인 이 곤충은?','http://www.nature.go.kr/fileUpload/photo/O1/ZOEC0011_1.jpg','두점박이사슴벌레','곤충'),(9,'노란산 잠자리의 몸 색상과 무늬는 암수가 약간 다른데 성숙한 암컷의 날개에는 이 색의 무늬가 더 넓게 퍼져 있다. 이 색은 ? ','http://www.nature.go.kr/fileUpload/photo/D1/ZDAG0009_1.jpg','등황색','곤충'),(10,'상제나비는 앞뒤 날개 모두 이 색을 띈다 이 색은 ? ','http://www.nature.go.kr/fileUpload/photo/R1/ZRED0002_1.jpg','흰색','곤충');
...
-- Dump completed on 2023-02-06 20:53:29
