...
INSERT INTO `member_test` VALUES (1,2,'wrong',1),(1,3,'wrong',1),(1,4,'correct',1),(1,5,'correct',1),(1,26,'correct',4.52),(1,29,'correct',1.39),(1,13,'correct',3.65),(1,20,'correct',3.47),(1,21,'correct',4.96),(2,13,'correct',3.15),(2,30,'correct',5.09),(2,17,'correct',8.81),(2,22,'correct',1.54),(2,34,'correct',3.84),(1,32,'correct',4.39),(1,27,'correct',2.25),(1,34,'correct',3.43),(1,12,'correct',1.87),(1,15,'correct',1.51),(1,38,'correct',4.87),(1,40,'correct',5.79),(1,44,'correct',6.29),(1,43,'wrong',4.81),(1,39,'wrong',6.65),(1,35,'correct',11.75),(1,40,'correct',4.23),(1,38,'correct',2.89),(1,43,'wrong',1.79),(1,44,'correct',2.41),(1,41,'wrong',4.03),(1,38,'wrong',3.58),(1,44,'wrong',1.48),(1,37,'wrong',3.13),(1,40,'correct',2.74),(1,2,'correct',10.6),(1,5,'wrong',3.22),(1,8,'wrong',4.28),(1,9,'wrong',3.88),(1,4,'wrong',3.89),(1,30,'correct',1.06),(1,28,'correct',6.27),(1,21,'wrong',2.89),(1,26,'correct',4.84),(1,29,'wrong',2.56),(1,12,'correct',1.73),(1,17,'correct',3.03),(1,30,'correct',0.85),(1,28,'wrong',3.26),(1,11,'correct',3.3),(1,42,'wrong',1.95),(1,38,'wrong',2.89),(1,37,'wrong',3.51),(1,40,'correct',3.89),(1,35,'correct',2.49),(1,44,'correct',0.57),(1,37,'wrong',2.61),(1,42,'correct',1.17),(1,41,'wrong',3.07),(1,38,'correct',2.84),(1,8,'wrong',3.29),(1,5,'wrong',4.12),(1,9,'wrong',5.5),(1,2,'correct',6.42),(1,7,'correct',7.78),(1,3,'correct',8.13),(1,8,'correct',9.85),(1,9,'correct',6.31),(1,6,'correct',7.47),(1,2,'wrong',4.38),(1,7,'correct',4.4),(1,3,'wrong',6.11),(1,9,'wrong',3.09),(1,2,'wrong',2.45),(1,8,'wrong',2.68),(1,37,'wrong',2.46),(1,42,'correct',1.46),(1,36,'correct',3.39),(1,35,'correct',2.6),(1,38,'correct',2.43),(1,7,'wrong',3.73),(1,8,'wrong',12.15),(1,6,'wrong',6.1),(1,4,'wrong',4.23),(1,3,'wrong',7.86),(1,23,'wrong',1.46),(1,16,'wrong',1.62),(1,13,'correct',3.17),(1,20,'wrong',0.79),(1,21,'correct',3.36),(1,32,'wrong',2.34),(1,17,'correct',3.8),(1,11,'correct',2.97),(1,28,'wrong',3.29),(1,33,'correct',1.78),(1,14,'wrong',2.05),(1,32,'wrong',1.26),(1,17,'correct',3.71),(1,16,'wrong',1.08),(1,18,'correct',3.43),(1,19,'correct',1.78),(1,30,'correct',12.38),(1,28,'wrong',6.19),(1,11,'correct',2.94),(1,27,'correct',7.14),(1,17,'correct',3.84),(1,20,'correct',4.28),(1,18,'correct',7.69),(1,22,'correct',4.71),(1,33,'correct',2.24),(1,34,'correct',3.28),(1,20,'wrong',1.4),(1,21,'correct',3.11),(1,23,'wrong',1.25),(1,14,'wrong',1.91),(1,15,'correct',1.31),(1,24,'correct',1.33),(1,16,'wrong',1.08),(1,20,'wrong',2.37),(1,23,'wrong',3.02),(1,22,'correct',2.63),(1,17,'correct',2.71),(1,25,'correct',6.86),(1,16,'wrong',7.09),(1,19,'correct',2.33),(1,20,'wrong',0.99),(1,11,'correct',3.65),(1,27,'correct',1.77),(1,25,'correct',2.22),(1,32,'wrong',2.02),(9,26,'correct',2.05),(9,12,'correct',1.95),(9,15,'wrong',14.02),(9,32,'correct',13.99),(9,31,'wrong',13.06),(9,35,'correct',1.85),(9,40,'wrong',4.45),(9,38,'correct',1.92),(9,44,'correct',1.34),(9,39,'correct',2),(9,8,'wrong',4.14),(9,2,'correct',2.6),(9,10,'wrong',3.89),(9,3,'wrong',2.88),(9,5,'wrong',1.79),(9,43,'correct',2.71),(9,40,'correct',3.62),(9,35,'correct',2),(9,42,'correct',1.57),(9,37,'wrong',2.33),(1,13,'correct',4.23),(1,33,'correct',2.77),(1,17,'correct',3.33),(1,31,'correct',4.25),(1,29,'correct',2.21),(1,25,'correct',1.45),(1,21,'correct',2.79),(1,20,'correct',2.21),(1,12,'correct',1.39),(1,17,'correct',2.72),(1,43,'correct',1.97),(1,42,'correct',2.49),(1,39,'correct',3.49),(1,41,'correct',3.01),(1,45,'correct',2.36);
...
INSERT INTO `memberinfo` VALUES (1,'ksi','1234','김성일',3720,'4','학생'),(2,'kkt','1234','김기태',0,'4','학생'),(3,'lsb','1234','이상복',0,'0','선생'),(5,'jdh','1234','조동현',0,'4','선생'),(6,'bab','1234','아기태',0,'4','학생'),(7,'aaa','1234','김기퉤',0,'4','학생'),(9,'sss','1234','박기태',360,'4','학생'),(10,'qqq','1234','황기태',0,'4','학생'),(11,'eee','1234','정기태',0,'4','학생');
...
INSERT INTO `q&a` VALUES (1,'김성일','2023-02-07','어려워여','넘나 어려워여','악깡버하라고','이상복'),(2,'김성일','2023-02-08','교수님','진도가 너무 빨라용\n넘 하기시룸','포기하지마시고 따라오세요 ','이상복'),(3,'김성일','2023-02-08','교수님 하기시룸','너무 하기시룸 놀고싶음','응애','이상복'),(4,'김성일','2023-02-08','ㄴㅁㅇㄴㅁㅇ','ㅁㄴㅇㅁㄴㅇㅁㄴㅇ','열심히 하세요','이상복'),(5,'박기태','2023-02-10','안녕하세요 문의남깁니다','커리큘럼이 어떻게 되나요 ?\n','모르곘어요','이상복'),(6,'박기태','2023-02-10','문의남깁니다','사랑해요','사랑해요','이상복'),(7,'김성일','2023-02-10','교수님 정말 어렵습니다.','리얼루요....',NULL,NULL);
...
--
-- Table structure for table `학습진도`
--

DROP TABLE IF EXISTS `학습진도`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `학습진도` (
  `IDnum` int NOT NULL,
  `contents` varchar(45) DEFAULT NULL,
  `IDnumcontents` varchar(45) DEFAULT NULL,
  UNIQUE KEY `IDnumcontents_UNIQUE` (`IDnumcontents`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `학습진도`
--

LOCK TABLES `학습진도` WRITE;
/*!40000 ALTER TABLE `학습진도` DISABLE KEYS */;
INSERT INTO `학습진도` VALUES (2,'다람쥐','2다람쥐'),(1,'산굴뚝나비','1산굴뚝나비'),(1,'상제나비','1상제나비'),(1,'장수하늘소','1장수하늘소'),(1,'깊은산부전나비','1깊은산부전나비');
/*!40000 ALTER TABLE `학습진도` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-10 17:15:21
